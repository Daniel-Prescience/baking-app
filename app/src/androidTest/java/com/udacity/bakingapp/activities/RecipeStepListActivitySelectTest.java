        ...
        ViewInteraction textView = onView(
                allOf(withText("Recipe Detail"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Recipe Detail")));
